  ...
  return (
    <section className="relative">
      ...
      <div className="absolute top-4 right-4">
        ...
        {isOpen && (
          <div className="absolute z-10 top-12 right-0 bg-gray-600 border border-gray-300 rounded-lg shadow-lg p-4 transition-all duration-200">
            <div className="mt-2 flex flex-col space-y-2">
              <button
                className="bg-white text-black py-2 px-4 rounded transition duration-200"
